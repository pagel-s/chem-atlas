...
const guidedViews = {
  ...
  orbitals: [{ progress: 0, part: 's orbital' }, { progress: .5, part: 'p orbital' }, { progress: 1, part: 'Hybrid orbital' }, { progress: .5, part: 'Node' }],
...
const sceneLegends = {
  ...
  orbitals: ['positive phase', 'negative phase', 'node', 'nucleus'],
...
const observationPrompts = {
  ...
  orbitals: ['Find the 2s radial node; phase is not probability density.', 'Identify the 2p nodal plane and opposite lobes.', 'Switch to four sp3 combinations and count four functions.', 'Explain why the basis count stays four.'],
...
function sceneReadout(id, progress, parameters = {}, mechanismId = 'sn2') {
  ...
  const values = {
    ...
    orbitals: [['View', progress < .25 ? '2s radial node' : progress < .75 ? '2px nodal plane' : '4 equivalent sp3'], ['Basis count', '4 -> 4'], ['Colour', 'wavefunction phase']],
