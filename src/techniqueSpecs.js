...
export const techniqueSpecs = [
...

  {
    ...
    evidence: 'Anthracene (C14H10) in cyclohexane: absorption max ~356 nm, emission max ~402 nm, Stokes shift ~46 nm (about 3200 cm-1), fluorescence lifetime ~5 ns, quantum yield ~0.27. Timescales: absorption ~10^-15 s, vibrational relaxation ~10^-12 s, fluorescence ~10^-9 s. The Jablonski diagram is schematic; triplet states, intersystem crossing and quenching are omitted.',
    control: ['Absorb', 'Emit'],
    ...
    parts: {
      ...
      Molecule: 'Anthracene — three fused aromatic rings. Its delocalised π system is what absorbs, and it is the molecule itself that lights up: excited while it sits in S₁, then flashing as it emits.',
      'Absorbed photon': 'A photon at ~356 nm for anthracene. Absorption takes ~10⁻¹⁵ s — far faster than the nuclei can respond.',
      'Emitted photon': 'A photon at ~402 nm. It is lower in energy than the one absorbed because energy was shed as heat both before and after the emission step.',
      'Stokes shift': 'The gap between the absorption and emission maxima: ~46 nm for anthracene. It exists because vibrational relaxation is ~1000× faster than emission, so the molecule always relaxes before it emits.',
    },
    steps: [
      ...
      ['That is the Stokes shift', 'Energy was lost as heat both before and after the photon was emitted, so the emitted photon must be lower in energy than the absorbed one. Anthracene absorbs at ~356 nm and emits at ~402 nm — a Stokes shift of ~46 nm. It is also why you can filter out the excitation light and see only the fluorescence.'],
    ],
    ...
    observationPrompts: [
      ...
      'Anthracene absorbs 356 nm and emits 402 nm: a 46 nm Stokes shift.',
    ],
    readout: (progress) => [
      ...
      ['Result', progress < .62 ? '—' : 'emitted 402 nm vs absorbed 356 nm'],
    ],
    spectrum: () => ({
      kind: 'peaks',
      title: 'Anthracene · absorption & emission',
      subtitle: 'Stokes shift ≈ 46 nm (356 → 402 nm)',
      left: '320 nm', right: '460 nm',
      // axis runs 320 -> 460 nm; x = (nm - 320) / 140
      band: [{ x: (356 - 320) / 140, h: .95, label: 'abs 356' }],
      peaks: [{ x: (402 - 320) / 140, h: .85, label: 'em 402' }],
      noCursor: true,
    }),
  },
];
